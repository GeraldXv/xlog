...
/**
 * Generic UI controller for managing the account-to-service-provider connection
 * flow.
 * <ul>
 * <li>GET /connect/{providerId} - Get a web page showing connection status to
 * {providerId}.</li>
 * <li>POST /connect/{providerId} - Initiate an connection with {providerId}.</li>
 * <li>GET /connect/{providerId}?oauth_verifier||code - Receive {providerId}
 * authorization callback and establish the connection.</li>
