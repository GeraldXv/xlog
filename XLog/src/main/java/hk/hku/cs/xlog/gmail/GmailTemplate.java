...
public class GmailTemplate extends GmailClient {
	...
	/**
	 * Constructor that defaults to {@code ImapGmailLabel.INBOX.getName()} as
	 * source {@link Folder} name.
	 */
	 ...
	 * 
	 * @param label
	 *            source {@link Folder} name.See {@see ImapGmailLabel}
	 * @see ImapGmailLabel
	 * @since 0.4
	 */
	 ...
	 * Logger
	 */
	private static final Log LOG = LogFactory.getLog(GmailTemplate.class);
	...
	public List<JavaMailGmailMessage> getAllMessages() {
		try {
	 ...
	 *             if GmailConnection is not ImapGmailConnection
	 */
	...
	/**
	 * Moves given {@link GmailMessage}'s to {@link ImapGmailLabel.Trash}
	 * folder.
	 * 
	 * @param gmailMessages
	 *            {@link GmailMessage} message(s)
	 * @throws GmailException
	 *             if unable to move {@link GmailMessage}'s to the Trash Folder
	 */
	 ...
	 * 
	 * @param messageNumber
	 *            the message number ex:{@code gmailMessage.getMessageNumber()}
	 * @throws GmailException
	 *             if unable to mark {@link GmailMessage} as read
	 */
	 ...
	 * 
	 * @throws GmailException
	 *             if unable to mark all {@link GmailMessage} as read
	 */
	 ...
	 *            the message number ex:{@code gmailMessage.getMessageNumber()}
	 * @throws GmailException
	 *             if unable to mark {@link GmailMessage} as unread
	 */
	 ...
	 *            the message number ex:{@code gmailMessage.getMessageNumber()}
	 * @throws GmailException
	 *             if unable to flag {@link GmailMessage} as starred
	 */
	 ...
	 *            the message number ex:{@code gmailMessage.getMessageNumber()}
	 * @throws GmailException
	 *             if unable to remove star flag from {@link GmailMessage}
	 */
	 ...
	 * 
	 * @param destFolder
	 *            the destination {@link Folder} name.See {@see ImapGmailLabel}
	 * @param messageNumber
	 *            the message number ex:{@code gmailMessage.getMessageNumber()}
	 * @throws GmailException
	 *             if it fails to move {@link GmailMessage} to the destination
	 *             folder
	 */
	...
	/**
	 * Returns list of unread/read priority {@link GmailMessage} objects based
	 * on the {@code unreadOnly} value
	 * 
	 * @param unreadOnly
	 *            {@code true} to unread priority {@link GmailMessage} objects
	 *            only, {@code false} to read priority {@link GmailMessage}
	 *            objects only
	 * @return List of unread/read priority messages
	 * @throws GmailException
	 *             if unable to get unread/read priority messages
	 */
	 ...
	 * {@link ImapGmailLabel} name. Note that a {@link Folder} object is
	 * returned only if the named {@link Folder} physically exist on the Store.
	 * 
	 * @param name
	 *            the name of the folder
	 * @param store
	 *            instance of Gmail {@link Store}
	 */
	...
	/**
	 * Close any {@link Folder} that contain {@link Message} and are in open
	 * state.
	 * 
	 * @param folder
	 *            {@link Folder} to be closed
	 */
