...
<h4><a href="<c:url value="/google"/>">Google+</a></h4>
<social:connected provider="google">
<ul class="menu">
	<li><a href="<c:url value="/google"/>">User Profile</a></li>
	<li><a href="<c:url value="/googleplus/feed"/>">Feed</a></li>
	<li><a href="<c:url value="/googleplus/friends"/>">Friends</a></li>
	<li><a href="<c:url value="/googleplus/tasks"/>">Albums</a></li>
</ul>
</social:connected>
